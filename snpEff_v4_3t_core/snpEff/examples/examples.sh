...
# java -Xmx4g -jar snpEff.jar -v -interval featuredb/encode/wgEncodeDukeDnase8988T.fdr01peaks.hg19.bb $genome examples/test.1KG.vcf > examples/test.1KG.ann_encode.vcf
